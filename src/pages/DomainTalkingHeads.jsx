...
export default function DomainTalkingHeads({ themeKey, typeKey }) {
  ...
  const stickers = isMobile ? [
    { top: '5%', left: '5%', rotate: -8, variant: 'tape', tape: T.popA, bg: mint, icon: '🎙', label: 'Audio', name: 'Crystal Clear', iconBg: T.ink, size: 'sm', scale: 0.8, zIndex: 20 },
    { top: '8%', right: '5%', rotate: 12, variant: 'torn', bg: sky, icon: '🔴', label: 'Action', name: 'Record Now', iconBg: T.popC, size: 'sm', scale: 0.8, zIndex: 20 },
    { top: '85%', left: '5%', rotate: -5, variant: 'square', bg: peach, icon: '🎥', label: 'Visual', name: '4K Crisp', iconBg: T.ink, size: 'sm', scale: 0.8, zIndex: 20 },
    { top: '88%', right: '5%', rotate: 9, variant: 'tape', tape: T.popB, bg: butter, icon: '🗣', label: 'Delivery', name: 'Authentic', iconBg: T.popA, size: 'sm', scale: 0.8, zIndex: 20 }
  ] : isTablet ? [
    { top: '8%', left: '8%', rotate: -8, variant: 'tape', tape: T.popA, bg: mint, icon: '🎙', label: 'Audio', name: 'Crystal Clear', iconBg: T.ink, size: 'md', scale: 0.75, zIndex: 20 },
    { top: '5%', right: '10%', rotate: 12, variant: 'torn', bg: sky, icon: '🔴', label: 'Action', name: 'Record Now', iconBg: T.popC, size: 'md', scale: 0.75, zIndex: 20 },
    { top: '85%', left: '8%', rotate: -5, variant: 'square', bg: peach, icon: '🎥', label: 'Visual', name: '4K Crisp', iconBg: T.ink, size: 'md', scale: 0.75, zIndex: 20 },
    { top: '88%', right: '10%', rotate: 9, variant: 'tape', tape: T.popB, bg: butter, icon: '🗣', label: 'Delivery', name: 'Authentic', iconBg: T.popA, size: 'md', scale: 0.75, zIndex: 20 }
  ] : [
    { top: '12%', left: '12%', rotate: -8, variant: 'tape', tape: T.popA, bg: mint, icon: '🎙', label: 'Audio', name: 'Crystal Clear', iconBg: T.ink, size: 'md', zIndex: 20 },
    { top: '5%', right: '40%', rotate: 12, variant: 'torn', bg: sky, icon: '🔴', label: 'Action', name: 'Record Now', iconBg: T.popC, size: 'md', zIndex: 20 },
    { top: '45%', right: '2%', rotate: 7, variant: 'square', bg: peach, icon: '🎥', label: 'Visual', name: '4K Crisp', iconBg: T.ink, size: 'md', zIndex: 20 },
    { top: '82%', right: '15%', rotate: -11, variant: 'tape', tape: T.popB, bg: butter, icon: '🗣', label: 'Delivery', name: 'Authentic', iconBg: T.popA, size: 'md', zIndex: 20 },
    { top: '88%', left: '40%', rotate: -5, variant: 'torn', bg: lilac, icon: '🎬', label: 'Set', name: 'Action', iconBg: T.popB, size: 'md', zIndex: 20 },
    { top: '50%', left: '2%', rotate: 9, variant: 'tape', tape: T.popC, bg: mint, icon: '✨', label: 'Edit', name: 'Polished', iconBg: T.ink, size: 'md', zIndex: 20 },
    { top: '15%', right: '12%', rotate: -4, variant: 'torn', bg: sky, icon: '✂', label: 'Cut', name: 'Fast Paced', iconBg: T.popB, size: 'md', zIndex: 20 },
    { top: '78%', left: '10%', rotate: 11, variant: 'tape', tape: '#b0b0b0', bg: peach, icon: '🎯', label: 'Focus', name: 'Eye Contact', iconBg: T.popA, size: 'md', zIndex: 20 }
  ];
  ...
  return (
    <div style={{ background: T.paper, color: T.ink, minHeight: '100vh', fontFamily: F.body }}>
      ...
      <section style={{
        ...
        overflow: 'hidden',
        background: `
          radial-gradient(circle at 15% 10%, ${'#3498db'}33 0%, transparent 35%),
          radial-gradient(circle at 85% 20%, ${'#3498db'}22 0%, transparent 35%)
        `
      }}>
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 1400, margin: '0 auto' }}>
          ...
          <div style={{ display: isMobile ? 'none' : 'flex', justifyContent: 'space-between', fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 40, fontFamily: F.body }}>
            <span>✳ Domain — Talking Heads</span>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: isMobile ? 450 : 650, position: 'relative' }}>
            ...
            <h1 style={{ 
              ...
              talking<br/><span style={{ fontFamily: F.italic, fontStyle: 'italic', fontWeight: 400, color: '#3498db' }}>heads</span>
            </h1>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', alignItems: isMobile ? 'center' : 'start', gap: isMobile ? 40 : 20, marginTop: isMobile ? 40 : 80 }}>
            <div style={{ fontFamily: F.italic, fontStyle: 'italic', fontSize: 'clamp(20px, 3vw, 28px)', lineHeight: 1.25, textAlign: 'center', color: T.ink, flex: 1, maxWidth: isMobile ? '100%' : 400, order: isMobile ? 1 : 2 }}>
              <em>Direct, clear, authentic communication. <span style={{ color: '#3498db' }}>Human connection.</span></em>
            </div>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.5, maxWidth: 320, fontFamily: F.body, textAlign: isMobile ? 'center' : 'left', flex: 1, order: isMobile ? 2 : 1 }}>
              ...
              <p style={{ margin: 0 }}>We put the human connection back into your brand's messaging with top-tier production.</p>
            </div>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.5, maxWidth: 320, fontFamily: F.body, textAlign: isMobile ? 'center' : 'right', flex: 1, order: 3 }}>
              ...
              <p style={{ margin: 0 }}>Authority, trust, and a polished presence that speaks directly to your audience.</p>
            </div>
          </div>
